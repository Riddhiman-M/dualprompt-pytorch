...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--dataset', default='DomainNet', type=str, help='dataset name')
    ...
    subparsers.add_argument('--num_tasks', default=15, type=int, help='number of sequential tasks')
